...
For factual questions always use the available tools — never answer from memory.
For multi-part questions call one tool per fact, then synthesise all results into
